    ...
    return (
        <section className="z-10 h-screen w-screen flex items-center justify-center">
            <div className="flex flex-col justify-between w-auto items-center space-y-6 ">
                ...
                <p className={`${subHeadingStyle} `}>Software developer from Edinburgh. I have experience in front-end and back-end development, I enjoy refining code and streamlining processes.</p>
            </div>
        </section>
    )
}