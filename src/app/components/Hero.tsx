    ...
    return (
        <section className="z-10 h-screen w-screen flex items-center justify-center">
            <main className="flex flex-col items-center justify-center w-3/5 space-y-4">
                <h1 className="text-8xl font-sans font-semibold tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-200">Creative Develope<span className="bg-transparent animate-pulse">r</span></h1>
