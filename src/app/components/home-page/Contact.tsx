    ...
    const ContactForm = () => {
        ...
        return (
            <Box className="grid grid-cols-2 gap-4 p-4 w-full h-auto bg-white border rounded-md border-zinc-200 dark:bg-black dark:border-zinc-800 shadow-md dark:shadow-zinc-950">
                <TextField disabled={!session} key={"name"} onChange={(e) => handleChange(e)} value={formInputs.name} className="dark:bg-stone-950" id="outlined-basic" name="name" label="Name" InputProps={{ placeholder: "", style: placeholderStyle }} InputLabelProps={{ style: placeholderStyle }} variant="outlined" />
                <TextField disabled={!session} key={"email"} onChange={(e) => handleChange(e)} value={formInputs.email} className='dark:bg-stone-950' id="outlined-basic" label="E-mail" name="email" variant="outlined" InputProps={{ placeholder: "", style: placeholderStyle }} InputLabelProps={{ style: placeholderStyle }} />
                <TextField disabled={!session} key={"subject"} onChange={(e) => handleChange(e)} value={formInputs.subject} className="col-span-2 dark:bg-stone-950" fullWidth id="outlined-basic" label="Subject" name="subject" variant="outlined" InputProps={{ placeholder: "", style: placeholderStyle }} InputLabelProps={{ style: placeholderStyle }} />
                <TextField disabled={!session} key={"message"} onChange={(e) => handleChange(e)} value={formInputs.message} className="col-span-2 dark:bg-stone-950" fullWidth multiline id="outlined-basic" name="message" label="Message" variant="outlined" InputProps={{ placeholder: "", style: placeholderStyle }} InputLabelProps={{ style: placeholderStyle }} />
                {
