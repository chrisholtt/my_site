...
export default async function Page({ params }: any) {
    ...
    return (
        <section className="h-screen" >
            <div className='relative flex flex-row justify-start items-center h-1/3 bg-red-200 border-zinc-200 dark:bg-black dark:border-zinc-800'>
            ...
            <div className="relative h-2/3 flex flex-col items-center justify-center text-center bg-zinc-50 border-t border-b border-zinc-200 dark:bg-stone-950 dark:border-zinc-800">
                <div className='absolute -top-16 flex flex-col justify-center items-center border rounded dark:bg-gradient-to-b dark:from-black dark:to-stone-950 dark:border-zinc-800 bg-gradient-to-b from-white to-zinc-50 border-zinc-200 shadow-md dark:shadow-black'>
