...
export default function Contact() {
    ...
    return (
        <section className="relative h-screen w-screen flex flex-col items-center justify-center bg-zinc-50 border-t border-b border-zinc-200 dark:bg-stone-900 dark:border-zinc-700" style={{ height: '50vh' }}>
